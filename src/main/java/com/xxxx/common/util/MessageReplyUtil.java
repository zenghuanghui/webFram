...
import com.xxxx.common.bean.output.*;
...
public class MessageReplyUtil {
    ...
    public static String sendImageTextMessage(NewsOutputMessage message) {
        ...
        sb.append("<MsgType><![CDATA[" + MessageRevieveUtil.IMAGE_TEXT_MESSAGE + "]]></MsgType>");
    ...
    public static String sendMusicMessage(MusicOutputMessage message) {
        ...
        sb.append("<FromUserName><![CDATA[" + message.getFromUserName() + "]]></FromUserName>");
        sb.append("<CreateTime>" + message.getCreateTime() + "</CreateTime>");
        sb.append("<MsgType><![CDATA[" + MessageRevieveUtil.MUSIC_MESSAGE + "]]></MsgType>");
        sb.append("<Music>");
    ...
    public static String sendVideoMessage(VideoOutPutMessage message) {
        ...
        sb.append("<FromUserName><![CDATA[" + message.getFromUserName() + "]]></FromUserName>");
        sb.append("<CreateTime>" + message.getCreateTime() + "</CreateTime>");
        sb.append("<MsgType><![CDATA[" + MessageRevieveUtil.VIDEO_MESSAGE + "]]></MsgType>");
        sb.append("<Video>");
    ...
    public static String sendVoiceMessage(VoiceOutputMessage message) {
        ...
        sb.append("<FromUserName><![CDATA[" + message.getFromUserName() + "]]></FromUserName>");
        sb.append("<CreateTime>" + message.getCreateTime() + "</CreateTime>");
        sb.append("<MsgType><![CDATA[" + MessageRevieveUtil.VOICE_MESSAGE + "]]></MsgType>");
        sb.append("<Voice>");
    ...
    public static String sendImageMessage(ImageOutputMessage message) {
        ...
        sb.append("<FromUserName><![CDATA[" + message.getFromUserName() + "]]></FromUserName>");
        sb.append("<CreateTime>" + message.getCreateTime() + "</CreateTime>");
        sb.append("<MsgType><![CDATA[" + MessageRevieveUtil.IMAGE_MESSAGE + "]]></MsgType>");
        sb.append("<Image>");
    ...
    public static String sendTextMessage(TextMessage message) {
        ...
        sb.append("<FromUserName><![CDATA[" + message.getFromUserName() + "]]></FromUserName>");
        sb.append("<CreateTime>" + message.getCreateTime() + "</CreateTime>");
        sb.append("<MsgType><![CDATA[" + MessageRevieveUtil.TEXT_MESSAGE + "]]></MsgType>");
